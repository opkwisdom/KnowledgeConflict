...
def main():
    ...
    name = f"{config.exp_type}_LR={config.train.learning_rate}_BS={config.data.batch_size}_AGB={config.train.accumulate_grad_batches}_freeze={config.train.freeze_pretrained}"
