...
echo "Sleep for 1h to wait"
sleep 1h
tmux new-session -d -s genloss

# 0번 GPU
tmux rename-window -t genloss:0 'GPU_0'
tmux send-keys -t genloss:0 "conda activate vllm && CUDA_VISIBLE_DEVICES=0 python src/sys_genloss_precompute_table.py --input_file mhqa_train_half_aa.jsonl --output_file sys_short_out_0" C-m

# 1번 GPU
tmux new-window -t genloss -n 'GPU_1'
tmux send-keys -t genloss:1 "conda activate vllm && CUDA_VISIBLE_DEVICES=1 python src/sys_genloss_precompute_table.py --input_file mhqa_train_half_ab.jsonl --output_file sys_short_out_1" C-m

# 2번 GPU (동일 반복...)
tmux new-window -t genloss -n 'GPU_2'
tmux send-keys -t genloss:2 "conda activate vllm && CUDA_VISIBLE_DEVICES=2 python src/sys_genloss_precompute_table.py --input_file mhqa_train_half_ac.jsonl --output_file sys_short_out_2" C-m

# 3번 GPU
tmux new-window -t genloss -n 'GPU_3'
tmux send-keys -t genloss:3 "conda activate vllm && CUDA_VISIBLE_DEVICES=3 python src/sys_genloss_precompute_table.py --input_file mhqa_train_half_ad.jsonl --output_file sys_short_out_3" C-m
...
# # 0번 GPU
# tmux rename-window -t genloss:0 'GPU_0'
# tmux send-keys -t genloss:0 "conda activate vllm && CUDA_VISIBLE_DEVICES=0 python src/genloss_precompute_table.py --input_file mhqa_train_half_post_aa.jsonl --output_file short_post_out_0" C-m

# # 1번 GPU
# tmux new-window -t genloss -n 'GPU_1'
# tmux send-keys -t genloss:1 "conda activate vllm && CUDA_VISIBLE_DEVICES=1 python src/genloss_precompute_table.py --input_file mhqa_train_half_post_ab.jsonl --output_file short_post_out_1" C-m

# # 2번 GPU (동일 반복...)
# tmux new-window -t genloss -n 'GPU_2'
# tmux send-keys -t genloss:2 "conda activate vllm && CUDA_VISIBLE_DEVICES=2 python src/genloss_precompute_table.py --input_file mhqa_train_half_post_ac.jsonl --output_file short_post_out_2" C-m

# # 3번 GPU
# tmux new-window -t genloss -n 'GPU_3'
# tmux send-keys -t genloss:3 "conda activate vllm && CUDA_VISIBLE_DEVICES=3 python src/genloss_precompute_table.py --input_file mhqa_train_half_post_ad.jsonl --output_file short_post_out_3" C-m
