...
class ConflictFeatureDetector(nn.Module):
...
class ConflictFeatureDetectorModule(LightningModule):
    def __init__(self, cfg: DictConfig, model: ConflictFeatureDetector):
        super().__init__()
