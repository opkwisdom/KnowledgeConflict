...
def plot_dist(f):
    ...
    plt.tight_layout()
    plt.savefig(f"src/tests/oracle_dist/short_wo_gold_genloss_oracle_dist.png")
    plt.close()
...
def ds_dependent_plot_dist(f, ds_ids_list, name):
    ...
    plt.tight_layout()
    plt.savefig(f"src/tests/oracle_dist/{name}_short_wo_gold_genloss_oracle_dist.png")
    plt.close()
