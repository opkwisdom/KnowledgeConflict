...
from src.utils import (
    load_config, setup_logger, load_relevance_dataset, compute_metrics, check_answer, MetricResult,
    apply_template,
...
def run_baseline_inference(
    ...
    for idx, item in tqdm(enumerate(data), desc="Running Pure Inference", total=len(data)):
        ...
        results[f"pure_result"].append(sample_result)
    return results
